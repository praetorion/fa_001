namespace FaxAgentSvc.Context.Controllers
{
    ...
    [FaxAgentAuthorize]
    [RoutePrefix("api/faxagent")]
    public class FaxAgentApiController : ApiController
    {
        private readonly FaxServerHostContext _faxServer;

        public FaxAgentApiController(FaxServerHostContext faxServer)
        {
        ...
        [HttpPost, Route("BulkChannelSave")]
